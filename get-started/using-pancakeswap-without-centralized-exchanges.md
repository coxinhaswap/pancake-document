...
description: >-
  ...
  other centralized exchange to start using CoxinhaSwap!
---

# Using CoxinhaSwap without Centralized Exchanges

CoxinhaSwap is a decentralized application. That means, unlike Binance or other centralized platforms, you don't need to register account to use it... you just need a crypto wallet. So how can you get crypto onto CoxinhaSwap without using a centralized exchange?

In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your BNB Smart Chain wallet, and start using CoxinhaSwap.
...
11. Once you complete the transaction. You should receive your fund in BNB Smart Chain wallet in a few minutes. After that, you can start using CoxinhaSwap to swap some tokens on BNB Smart Chain!
...
10. Once finished. You should receive your fund in your BSC wallet. Now you can start using CoxinhaSwap to swap some tokens on BNB Smart Chain!
{% endtab %}
...
10. Once finished. You should receive your funds in your BSC wallet. Now you can start using CoxinhaSwap to swap some tokens on BNB Smart Chain!
