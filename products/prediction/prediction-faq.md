...
### What’s the CoxinhaSwap Prediction contract address?
...
The treasury fee is currently set at 3%: this may be subject to changes, which would be announced on CoxinhaSwap’s official communication channels. Treasury fees are used to buy back and burn CAKE tokens.
...
CoxinhaSwap uses two sources for our price feeds. They each have their own purpose within the prediction market:
...
* Used for real-time price updates on the CoxinhaSwap prediction market interface.
...
### What causes CoxinhaSwap Prediction market to pause?
