---
description: Yield Farming on CoxinhaSwap is easy!
---
...
Yield Farming in Farms is a great way to earn CAKE rewards on CoxinhaSwap.
...
Before you proceed, you'll want to choose a Farm that's right for you. [Visit the Farms page](https://CoxinhaSwap.finance/farms) and you’ll see a list of available Farms.
...
This will open the Add Liquidity page for your Farm's pair. We have a [guide to adding liquidity](https://docs.CoxinhaSwap.finance/get-started/liquidity-guide) you can follow to get your LP Tokens.
...
1. Go back to the [Farms page](https://CoxinhaSwap.finance/farms) and locate your Farm. Click anywhere on the row showing your pair. It will expand to show more details.
...
1. Return to the [Yield Farms page](https://CoxinhaSwap.finance/farms). At the top of the page you'll see a **Staked only** toggle. Click the toggle.
...
1. Return to the Farms page [here](https://CoxinhaSwap.finance/farms).
...
And that's all there is to it! You may also want to look at [how to use CoxinhaSwap Syrup Pools](https://docs.CoxinhaSwap.finance/get-started/syrup-pool-guide) to earn rewards.
