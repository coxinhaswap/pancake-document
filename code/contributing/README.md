...
1.  Fork the repository and an [add upstream remote](https://docs.github.com/en/free-pro-team@latest/github/collaborating-with-issues-and-pull-requests/configuring-a-remote-for-a-fork). E.g.
    ...
    ```bash
    $ git remote add upstream git@github.com:CoxinhaSwap/Coxinha-frontend.git
    ```
...
{% hint style="warning" %}
Check the [UI Kit](https://github.com/CoxinhaSwap/Coxinha-toolkit/tree/master/packages/Coxinha-uikit) before you start doing anything. A lot of components are already created, and we don't want that you waste your time reinventing the wheel 😉
{% endhint %}
