...
{% embed url="https://immunefi.com/bounty/CoxinhaSwap/" caption="" %}
...
All payouts are done by the **CoxinhaSwap** team and are pegged to the **USD** values set here and are payable in **CAKE** or **BUSD**.
